...
public class dialogVendedor extends javax.swing.JDialog {
    ...
    private void carregaComboFuncao(){
        DefaultComboBoxModel cbm = new DefaultComboBoxModel(Cargo.values());
        cbFuncao.setModel(cbm);
    }
    
    private boolean camposValidos(){
        return(
                !(txtNome.getText().trim().isEmpty()) && !(txtCPF.equals("   .   .   -  ")) && !(txtData.equals("  /  /    "))
        );
    }
    
    private Vendedor criaObjeto(){
        ...
        v.setCargo((Cargo)cbFuncao.getSelectedItem());
        return(v);
    }
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(cbFuncao, 0, 100, Short.MAX_VALUE))
        ...
        lista.setBorder(javax.swing.BorderFactory.createTitledBorder("Lista de funcionarios"));
    ...
    private void listaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listaMouseClicked
        if (evt.getClickCount()==2){
            Vendedor v = (Vendedor)lista.getSelectedValue();
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        try{
            ...
            this.limpaComponentes();
            this.atualizaLista();
            JOptionPane.showMessageDialog(null, "Vendedor gravado");
